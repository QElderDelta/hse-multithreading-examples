...
// Средняя функция (умножение и деление)
...
// Фиксированный размер данных, разное количество потоков
...
// Фиксированное количество потоков, разный размер данных
